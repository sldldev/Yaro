...
export class AddAlbumComponent implements OnInit {
  ...
  albumEdit: Album; // information about the edited album in case in edit mode
   ...
   */
  constructor(public albumsService: AlbumService, public route: ActivatedRoute) {
  }
  ...
  onSaveAlbum(form: NgForm) {
    ...
    if (this.mode === 'create') { // if we are creating new album
      const album: Album = {
        ...
        AlbumName: form.value.album, // album name
      ...
      this.albumsService.updateAlbum(this.albumId, form.value.album, form.value.info, this.albumEdit.Date);
    }
